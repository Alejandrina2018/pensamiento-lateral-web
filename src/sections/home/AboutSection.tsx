...
//
// No longer wrapped in an inner `max-w-4xl mx-auto` — that made this
// section's overall block visibly narrower than its siblings (Servicios,
// Método, Distintos desafíos), which all use Container's full content
// width directly. Individual text elements still cap their own line
// length via max-w-(--measure)/(--measure-narrow), same idiom used
// everywhere else on the page — only the section's outer width changed.
export default function AboutSection() {
  return (
    <section className="bg-(--color-blue-tint)">
      <Container className="py-24 md:py-32">
        <Eyebrow>Pensamiento Lateral</Eyebrow>
        <h2 className="mt-4 max-w-3xl text-display-lg font-semibold text-slate">
        ...
        <div className="mt-10 grid gap-8 md:max-w-4xl md:grid-cols-2 md:gap-12">
